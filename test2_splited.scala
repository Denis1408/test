// Split version of test2.scala.
// Purpose: keep Databricks' generated notebook wrapper ($iw.<init>) small on Dedicated compute.
// All original TableSpec definitions are preserved; they are just distributed across helper methods.
// Final output remains: tables_init: Map[String, DataFrame]

// ================= TABLE SPECS PART 1 =================
def tablesSpecPart1(): Map[String, TableSpec] = {
  // NCATS_ACCIDENT
...
// ================= TABLE SPECS PART 2 =================
def tablesSpecPart2(): Map[String, TableSpec] = {
  // ADDRESS1
...
// ================= TABLE SPECS PART 3 =================
def tablesSpecPart3(): Map[String, TableSpec] = {
  // COMM_VEH_INFO 
...
// ================= TABLE SPECS PART 4 =================
def tablesSpecPart4(): Map[String, TableSpec] = {
  // ENVIR_FACTOR 
...
// ================= TABLE SPECS PART 5 =================
def tablesSpecPart5(): Map[String, TableSpec] = {
  // NAME2
  val NAME2 = TableSpec(
...
// ================= TABLE SPECS PART 6 =================
def tablesSpecPart6(): Map[String, TableSpec] = {
  // PAVE_TRAFF_MARK 
...
// ================= TABLE SPECS PART 7 =================
def tablesSpecPart7(): Map[String, TableSpec] = {
  // REVIEWED_BY 
...
// ================= TABLE SPECS PART 8 =================
def tablesSpecPart8(): Map[String, TableSpec] = {
  // VEH_INFO 
...
// ================= COMBINE ALL TABLE SPECS =================
val tablesSpec: Map[String, TableSpec] =
  tablesSpecPart1() ++
  tablesSpecPart2() ++
  tablesSpecPart3() ++
  tablesSpecPart4() ++
